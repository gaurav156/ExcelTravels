<template>
  <div class="p-6 pt-0">
    ...
    <div
      v-if="isModalOpen"
      class="fixed inset-0 bg-black bg-opacity-50 flex items-center justify-center p-4 z-50 overflow-y-auto modal-content"
    >
    <div
...
Please login to the app using the credentials above for more details.`;
    ...
    async fetchDutySlips() {
      ...
      try {
        ...
        Swal.fire({
          title: "Error!",
          text: "Error fetching duty slips.",
          icon: "error",
    ...
    async viewSlip(dutySlipId) {
      ...
      try {
        ...
        Swal.fire({
          title: "Error!",
          text: "Error fetching duty slip details.",
          icon: "error",
          confirmButtonColor: "#d33",
          confirmButtonText: "OK",
          customClass: {
